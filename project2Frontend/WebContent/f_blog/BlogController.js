 ...
 */myModule.controller("BlogController",function($scope,$http,$rootScope,$location)
{
	...
	$scope.blog={'blogId':0,'blogName':'','blogContent':'','createDate':'','loginname':'','likes':0,'dislikes':0,'status':'','comments':''};
	...
	$rootScope.comment=function(blog)
	{
		...
		$http.get('http://localhost:8085/project2Middleware/getAllComment/'+blog.blogId)
		.then(function(response)
		{
