...
Class classes[]=new Class[]{User.class, Blog.class, BlogComment.class, ProfilePicture.class, 
		Friend.class, Forum.class, ForumComment.class  };
	...
	public ForumDao getForumDao() {
		...
		System.out.println("forum bean created");
